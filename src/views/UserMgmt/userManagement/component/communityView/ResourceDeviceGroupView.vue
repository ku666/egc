      ...
      <div>
        ...
        <el-form-item label="供应商" :label-width="formLabelWidth">
          <el-select v-model="resourceDeviceGroupVue.providerCode" placeholder="请选择供应商" class="user_el-select">
            <el-option v-for="providerCodeType in providerOptions" :key="providerCodeType.itemCode" :label="providerCodeType.itemName" :value="providerCodeType.itemCode" disabled> </el-option>
          </el-select>
        </el-form-item>
      </div>
    </el-form>
