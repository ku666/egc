  ...
  <div>
    <el-form ref='resourceDeviceGroupVue' :inline="true" :model="resourceDeviceGroupVue" :rules="rules">
      ...
      <el-form-item label="设备类型" :label-width="formLabelWidth">
        <el-select v-model="resourceDeviceGroupVue.deviceType" placeholder="请选择" class="user_el-select">
      ...
      <div>
        <el-form-item label="组织树" :label-width="formLabelWidth">
          <org-tree @changeDialogStatus="_changeSatus" ref="orgTree"></org-tree>
        </el-form-item>
        <el-form-item label="设备供应商" :label-width="formLabelWidth">
      <!-- <el-form-item label="设备供应商" :label-width="formLabelWidth" prop="providerCode"> -->
        <el-select v-model="resourceDeviceGroupVue.providerCode" placeholder="请选择" class="user_el-select">
