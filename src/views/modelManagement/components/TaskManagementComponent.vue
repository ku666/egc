    ...
    <div class="margin-top-30">
      ...
      <el-table
        ...
        <el-table-column
          label="任务执行时间（秒）"
          width="180">
          <template slot-scope="scope">{{ scope.row.exeTimeInSec }}</template>
        </el-table-column>
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown @command="handleCommand($event, scope.$index, scope.row)" trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <!--<el-dropdown-item class="model-dropdown-item"><i class="el-icon-search"></i>运行状况</el-dropdown-item>-->
                <!--<el-dropdown-item class="model-dropdown-item"><i class="el-icon-remove"></i>停用</el-dropdown-item>-->
                <!--<el-dropdown-item class="model-dropdown-item" command="edit" divided><i-->
