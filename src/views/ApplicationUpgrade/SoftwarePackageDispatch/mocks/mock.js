...
Mock.mock(contextPath + '/auServers/queryPageData', function () {
  ...
  return {
    ...
    auServersList: [
      {
        uuid: '2885576c0d044b00b3e1294c8c7dddddd',
      ...
      {
        uuid: '2885576c0d045b00b3e1294c8aaaaa',
        hostname: 'GD-FS-YHJ-01-dell-R730-web-02',
        location: '恒大山水城一期',
        functionCode: 'server02',
        functionName: 'testServers02',
        cpuModel: 'Dell 730',
        numberOfCore: 123,
        cpuFreq: 8,
        biosVersion: '1.2',
      ...
      {
        uuid: '2885576c0d045b00b3e1296c8bbbbbb',
        hostname: 'GD-FS-YHJ-01-dell-R730-web-03',
        location: '恒大山水城一期',
        functionCode: 'server03',
        functionName: 'testServers03',
        cpuModel: 'Dell 730',
        numberOfCore: 123,
        cpuFreq: 8,
        biosVersion: '1.2',
...
Mock.mock(contextPath + '/auServers/get/id', function () {
  ...
  return {
    auServers: {
      uuid: '2885576c0d045baaaaaaaaaaa',
      hostname: 'GD-FS-YHJ-01-dell-R730-web-03',
      location: '恒大山水城一期',
      functionCode: 'server03',
      functionName: 'testServers03',
      ...
      auNetAdapters: [
        {
          uuid: '2885576c0d089b00b3e129bbbbbbbbbbbbbb',
          serverId: '172.16.30.254',
          name: 'Geforce 8008',
          adapterType: 'AMD',
          mac: '50-9A-4C-3A-4C-4F',
          ip: '192.168.1.1',
          bindWidth: null,
          provider: 'Hua Wei Ltd.',
          deleteFlag: 0,
          createTime: 1514943394149,
          createUser: 'sysytem',
          updateTime: 1514943394150,
        ...
        {
          uuid: '2885576c0d012b00b3e1294c8c7a616',
          serverId: '172.16.30.254',
          name: 'Geforce 8008',
          adapterType: 'AMD',
          mac: '50-9A-4C-3A-4C-4F',
        ...
        {
          uuid: '2885576c0d034b00b3e1294c8c7a616',
          serverId: '172.16.30.254',
          name: 'Geforce 8008',
          adapterType: 'AMD',
          mac: '50-9A-4C-3A-4C-4F',
      ...
      auPhds: [
        {
          uuid: '2885576c0d044ba0b3e1294c8c7a616',
          serverId: 313131,
          serialNo: 10022,
          spaceTotal: 80,
          spaceFree: 40,
        ...
        {
          uuid: '2885576c0d044bacb3e1294c8c7a616',
          serverId: 313131,
          serialNo: 10022,
          spaceTotal: 80,
          spaceFree: 40,
        ...
        {
          uuid: '2885576c0d090b00b3e1294c8c7a616',
          serverId: 313131,
          serialNo: 10022,
          spaceTotal: 80,
          spaceFree: 40,
    ...
    'auServersHisList': [
      {
        ...
        'changedData': '[{"propertyName":"hostName","desc":"主机名","oldValue":"恒大山水郡监控主机","newValue":"恒大山水郡test主机"},{"propertyName":"hostName","desc":"主机名","oldValue":"恒大山水郡监控主机","newValue":"恒大山水郡test主机"},{"propertyName":"hostName","desc":"主机名","oldValue":"恒大山水郡监控主机","newValue":"恒大山水郡test主机"}]',
        'changedDataDto': {
...
/** =================操作系统信息================================ */
Mock.mock(contextPath + '/osServices/queryPageData', function () {
  console.log('mock getauServersList')
  return {
    pageCount: 3,
    'auServicesList': [{
...
Mock.mock(contextPath + '/osServices/get/{id}', function () {
